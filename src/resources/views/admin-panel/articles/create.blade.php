    ...
    <form action="{{ route('admin.articles.store') }}" method="POST">
        ...
        <div class="columns-3 mb-9">
            ...
            <div class="input-group">
                ...
                <input id="time_read" name="time_read" type="text" class="input" value="{{ old('time_read') }}">
            </div>
            <div class="input-group">
                <label class="label">
                    Автор
                ...
                <input disabled value="{{ auth()->user()->name }}" type="text" class="input">
            </div>
        </div>
        <div class="columns-1 mb-9">
            <div class="input-group">
                ...
                <textarea name="tiny_description" id="tiny_description" class="input" rows="5" cols="33">{{ old('tiny_description') }}</textarea>
            </div>
        </div>
        <div class="columns-1 mb-9">
            <div class="input-group">
                ...
                <textarea name="description" id="description" class="input" rows="5" cols="33">{{ old('description') }}</textarea>
            </div>
        </div>
    </form>
