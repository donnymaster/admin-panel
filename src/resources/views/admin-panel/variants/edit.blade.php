                    ...
                    <div class="accordion__body">
                        @forelse ($category->properties as $property)
                            <div class="columns-1 mt-5">
                                <div class="input-group">
                                    <label title="{{$property->description}}" for="properties[{{$category->id}}][{{$loop->index}}][property-value]" class="label flex mb-2">
                        ...
                        @empty
                            <div class="empty-property text-center mt-3 mb-3 text-xl">
                                ...
                                <a class="link white" href="{{route('admin.catalog.category.edit', ['category' => $category->id])}}" href="">Добавить</a>
                            </div>
                        @endforelse
                        </div>
                    </div>
